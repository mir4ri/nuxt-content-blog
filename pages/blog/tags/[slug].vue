...
// set meta for page
useHead({
  title: `Всі статті з тегом ${slug}`,
  meta: [{ name: "description", content: "Всі записи по данній темі" }],
});
</script>
<template>
  <main>
    <header class="page-heading">
      <div class="wrapper">
        <h1 class="text-5xl font-extrabold">Всі статті з тегом "{{ slug }}"</h1>
        <p class="font-medium text-lg">Всі записи по данній темі</p>
      </div>
    </header>
